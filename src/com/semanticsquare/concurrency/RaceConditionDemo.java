...
//Race condition occurs when more than 1 threads try to WRITE the same memory location.
...
class BankAccount implements Runnable {
	...
	// just make it synchronized to avoid race condition
