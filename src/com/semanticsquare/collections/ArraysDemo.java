...
public class ArraysDemo {
	...
	private static void sequential() {
		...
		List<String> strings = Arrays.asList(strArray); // fixed-size // used to convert Array to ArrayList
		System.out.println("strings: " + strings);		
		//strings.remove(0); // cannot add or remove .. because it is fixed size
		//strings.add("a");
		strings.set(0, "john");
		...
		// to create a fixed size arraylist the below way we need to follow
