...
import java.util.Date;// most of the methods are not used // so changed to another class // Java 1.1
...
public class DateTimeDemo {
	...
	// the below function uses the latest date and time api. So use this for coding
	private static void testDateTimeAPI() {
		...
		// get returns an int
		System.out.println("year again: " + newExpiryDate.get(ChronoField.YEAR));  // ChronoField is a ENUM
		...
		Instant startTime = Instant.now();   // use nanotime for calculating the func executing time
		testLegacyDateAPI();  // added this to know how much time does it take to run this complete function
