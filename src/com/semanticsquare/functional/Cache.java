...
//abstract class Test {   // this will not work
//	abstract void apply();
//}
@FunctionalInterface
interface Test {
	void apply();
	default void apply1(){}; // made it default
	String toString(); // it is from object class , so automatically get it from there
}
...
public class Cache {		
    ...
    public static void main(String[] args) {
		...
		// Lambdas
		// can be written in all ways boys
		//Arrays.sort(recommendedItems.items, (Bookmark o1, Bookmark o2) ->  { return new Integer(o1.getTitle().length()).compareTo(new Integer(o2.getTitle().length()));});
		...
		new Cache(5).go(() -> System.out.println("\nLambda"));  // should be a functional interface .. do not declare as abstract class
